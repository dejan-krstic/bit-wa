...
- Suggestions on the SinglePostPage:
    - method that returns JSX
    - may contact authorService
- BackButton component uses window.history
- Navbar uses window.location
