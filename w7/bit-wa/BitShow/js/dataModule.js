    ...
    export const createShow = (name, image, showID) => new Show(name, image, showID);

    export const createSingleShow = (name, image, showID, info) => new SingleShow(name, image, showID, info);

    export const createSeason = (startDate, endDate) => new Season(startDate, endDate);

    export const createActor = (name) => new Actor(name);
    ...
    export const adaptShowsResponse = (showsResponse, showsOnPage) => {
        showsResponse.splice(showsOnPage);
        return createShowsArray(showsResponse);
    }
    //-------------------------------- single show obj----------------------- //
    export const fetchID = () => parseInt(location.href.slice(location.href.indexOf('id=')+3));
    ...
    export const adaptSingleResponse = (showResponse) => {
